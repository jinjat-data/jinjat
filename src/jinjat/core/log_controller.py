...
# Log File Path
LOG_PATH = Path.home().absolute() / ".jinjat" / "logs"
...
def logger(
    ...
    Args:
        name (str, optional): Logger name, also used for output log file name in `~/.jinjat/logs` directory.
        ...
        path (Path, optional): Path for output warning level+ log files. Defaults to `~/.jinjat/logs`
